...
# بلاي 
M = (
    "**𓆰**  𖣳سورس الفراعنة 𖣳   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━──━─𖣳سورس الفراعنة 𖣳━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𐇮 ŻẸĮŇ آلـۘهہؚيـٰـُ͢ـُ໋۠بـ໋ۘ۠ه 𐇮](t.me/devpokemon)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 **⪼**  [𖣳سورس الفراعنة 𖣳](https://t.me/S_EG_P)  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس الفراعنة ا",
        "الاستـخـدام": "{tr}بلاي",
    },
)
