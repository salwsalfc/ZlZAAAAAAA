...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ سورس الفراعنة - حفـظ الذاتيـه 🧧](t.me/wasit_go) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩سورس الفراعنة (t.me/wasit_go) 𓆪"
)
...
async def oho(event):
    ...
    await zedub.send_file("me", pic, caption=f"**- ❝ ⌊تـم حفـظ الصـورة ذاتيـة التدمير بنجـاح غير مبري ذمة الى يوم الدين اذا بتزيت بية ولد او ابنية  ☑️ 🥳𓆰...**")
    await event.delete()
