...
async def _(event):
    ...
    await edit_or_reply(event, "**✾╎جــارِ إيقـاف تشغيـل بـوت الفرعون  الآن 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/pp_g3")
