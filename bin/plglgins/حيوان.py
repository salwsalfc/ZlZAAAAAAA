...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𝐒ٰٖ𝐎ٰٖٖ𝐔ٰٖ᚜𝐑𝐙᚛ٰٖٖ𝐑ٰٖ𝐂ٰٖٖ𝐄ُٰ </b> - @wasit_go "
    ...
    if x == 2:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𖣳𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂𖣳 </b> - @wasit_go "
...
async def who(event):
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**- يقلب . . ده مطور السورس . . انتـه الحيـوان **")
    if replied_user.id == 5190136458 or replied_user.id == 627658332 or replied_user.id == 1121532100:
       return await edit_or_reply(zed, "**- يقلب . . انـهُ المطـور . . انتـه الحيـوان **")
